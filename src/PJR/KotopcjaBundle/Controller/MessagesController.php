...
use PJR\KotopcjaBundle\Entity\Messages;
use PJR\KotopcjaBundle\Form\MessagesType;
...
class MessagesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PJRKotopcjaBundle:Messages')->findAll();
     ...
     * @Method("POST")
     * @Template("PJRKotopcjaBundle:Messages:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PJRKotopcjaBundle:Messages')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PJRKotopcjaBundle:Messages:edit.html.twig")
     */
