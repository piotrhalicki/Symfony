...
use PJR\KotopcjaBundle\Entity\Pictures;
use PJR\KotopcjaBundle\Form\PicturesType;
...
class PicturesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('PJRKotopcjaBundle:Pictures')->findAll();
     ...
     * @Method("POST")
     * @Template("PJRKotopcjaBundle:Pictures:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('PJRKotopcjaBundle:Pictures')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("PJRKotopcjaBundle:Pictures:edit.html.twig")
     */
